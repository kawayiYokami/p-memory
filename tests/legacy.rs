...
fn world_tree_import_skips_dangling_and_parses_zoneless_timestamps() {
    ...
    source(&lookup, r#"
        ...
        INSERT INTO entities VALUES('e1','gi','Alice','person','','');
        INSERT INTO entities VALUES('e2','gi','Bob','person','','');
        INSERT INTO entity_aliases VALUES('gi','A','a','e1');
        INSERT INTO entity_attributes VALUES('e1','color','red',0);
        INSERT INTO relations VALUES('r1','gi','e1','knows','e2','','0.9','');
        INSERT INTO relations VALUES('r2','gi','e1','knows','ghost','','0.9','');
        INSERT INTO events VALUES('ev1','gi','结盟','','','','','');
